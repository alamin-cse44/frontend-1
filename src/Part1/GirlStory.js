...
const GirlStory = ({data}) => {
    return (
        <div className='mt-3 bg-white text-black'>
            <div className="h-96 overflow-hidden"> 
            <img width="100%" className='rounded-2xl p-3'  src={data[0].stories.coverImage} alt="" />
            </div>

            <h2 className='text-justify mt-5 font-medium p-5'>{data[0].stories.content}</h2>
